...
import { BookOpen, FlaskConical, Calculator, Target, ArrowRight } from 'lucide-react';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div className="card-panel" style={{ background: '#ffffff' }}>
        <h1 style={{ fontSize: '1.6rem', fontWeight: 800 }}>Subject-wise Lecture & Lab 75% Target Calculator</h1>
        <p style={{ color: 'var(--text-muted)', fontSize: '0.875rem', marginTop: '4px' }}>
          Calculated separately for Theory (Lectures) and Practical (Labs) per GTU academic rules.
        </p>
      </div>

      {/* Target Goal Planner Card: July 73% -> 01/09 Target ~70% */}
      <div className="card-panel" style={{ background: 'linear-gradient(135deg, #f0fdf4 0%, #ffffff 100%)', border: '2px solid #bbf7d0' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
          ...
          <div>
            <h2 style={{ fontSize: '1.1rem', fontWeight: 800, color: '#14532d' }}>Combined Target Goal Planner (July + August → 01/09/2026)</h2>
            <p style={{ fontSize: '0.8125rem', color: '#166534' }}>Calculate how many lectures you can miss in August to hit your target average!</p>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '20px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div>
              <label style={{ fontSize: '0.8125rem', fontWeight: 700, color: '#14532d' }}>July Baseline (06/07 to 31/07):</label>
            ...
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.8125rem', fontWeight: 700, color: '#14532d' }}>
          ...
          <div style={{ background: '#ffffff', border: '1px solid #bbf7d0', borderRadius: 'var(--radius-md)', padding: '16px', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '8px' }}>
            <div style={{ fontSize: '0.8125rem', color: '#166534', fontWeight: 700 }}>
              📊 EXPLANATION & TARGET STRATEGY:
            </div>
      ...
      <div className="card-panel" style={{ background: 'linear-gradient(135deg, #eff6ff 0%, #ffffff 100%)', border: '2px solid var(--primary-blue-border)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
          <div style={{ width: '36px', height: '36px', borderRadius: '10px', background: 'var(--primary-blue)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Calculator size={20} />
          </div>
          <div>
            <h2 style={{ fontSize: '1.1rem', fontWeight: 800 }}>Single Subject Simulator</h2>
            <p style={{ fontSize: '0.8125rem', color: 'var(--text-muted)' }}>Simulate future theory lectures or lab sessions</p>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '20px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            <div>
              <label style={{ fontSize: '0.8125rem', fontWeight: 700, color: 'var(--text-main)', display: 'block', marginBottom: '6px' }}>Select Subject:</label>
              <select
                value={simSubject}
                onChange={(e) => {
            ...
            <div>
              <label style={{ fontSize: '0.8125rem', fontWeight: 700, color: 'var(--text-main)', display: 'block', marginBottom: '6px' }}>Category:</label>
              <div style={{ display: 'flex', gap: '6px' }}>
                ...
                >
                  <BookOpen size={14} /> Lecture (Theory)
                </button>
                <button
                  type="button"
                  ...
                  style={{ flex: 1, padding: '7px', fontSize: '0.75rem' }}
                >
                  <FlaskConical size={14} /> Lab (Practical)
                </button>
              </div>
            </div>
          ...
          {/* Output Box */}
          <div style={{ background: '#ffffff', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-md)', padding: '20px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '12px', marginTop: '6px' }}>
              <div style={{ fontSize: '2.5rem', fontWeight: 800, color: projectedPercentage >= 75 ? 'var(--success-green)' : 'var(--danger-red)' }}>
          ...
          return (
            ...
            >
              <div>
                ...
                <h3 style={{ fontSize: '1.1rem', fontWeight: 800, marginTop: '6px', color: 'var(--text-main)' }}>
                  {sub.name}
                </h3>
              </div>
              ...
              <div style={{ background: '#f8fafc', padding: '12px', borderRadius: 'var(--radius-md)', border: '1px solid #e2e8f0' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                  <span style={{ fontSize: '0.8125rem', fontWeight: 700, color: 'var(--primary-blue)', display: 'flex', alignItems: 'center', gap: '6px' }}>
                    <BookOpen size={15} /> Theory (Lecture) Attendance
                  </span>
                  <span style={{ fontSize: '1.1rem', fontWeight: 800, color: sub.theory.conducted === 0 ? '#64748b' : sub.theory.percentage >= 75 ? 'var(--success-green)' : 'var(--danger-red)' }}>
                ...
                {sub.theory.conducted > 0 && (
                  <div style={{ marginTop: '6px', fontSize: '0.75rem', fontWeight: 600, color: sub.theory.percentage >= 75 ? '#166534' : '#991b1b' }}>
              ...
              <div style={{ background: '#f8fafc', padding: '12px', borderRadius: 'var(--radius-md)', border: '1px solid #e2e8f0' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                  <span style={{ fontSize: '0.8125rem', fontWeight: 700, color: '#7c3aed', display: 'flex', alignItems: 'center', gap: '6px' }}>
                    <FlaskConical size={15} /> Practical (Lab) Attendance
                  </span>
                  <span style={{ fontSize: '1.1rem', fontWeight: 800, color: sub.lab.conducted === 0 ? '#64748b' : sub.lab.percentage >= 75 ? 'var(--success-green)' : 'var(--danger-red)' }}>
                ...
                {sub.lab.conducted > 0 && (
                  <div style={{ marginTop: '6px', fontSize: '0.75rem', fontWeight: 600, color: sub.lab.percentage >= 75 ? '#166534' : '#991b1b' }}>
